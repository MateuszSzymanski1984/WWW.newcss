...
if ( $the_query->have_posts() ) {
	while ( $the_query->have_posts() ) {
		...
		<div class="row">
			...
			<div id="ofirmie">
				<div class="center">
					<span id="header">O FIRMIE</span>

					<div id="zawartosc">
						<div class="col-xs-12">
							<?php the_field('tekst_o_firmie', 5); ?>
						</div>
					</div><!--zawartosc-->
				</div><!--center-->
			</div><!--ofirmie-->
			...
			<div id="tlo2">
				...
				<div class="center_tlo2">
					<div class="tlo2_text"><?php the_field('nagłowek_banera_zamow'); ?></div>

					<div class="tlo2_text2"><?php the_field('tekst_banera_zamow'); ?></div>
